def gitUrl = "http://192.168.126.25/git/our-dev-group/police.git"
def branch = "master"
def credentialsId = "c078ac92-89dd-4842-8292-5e348e68db08"
def rootPath= "./sipsd-sso-s2-oauth2-gateway-web"
def appName = "ifp-gateway"
def bakPath = "/home/jenkins_bak"
def putPath = "/home/jenkins_put"
def publishPath= "/usr/local/nginx/html/iplatform/ifp-gateway"
